---
name: typo3-upgrade-full
description: "Activate with /typo3-workflows:typo3-upgrade-full to run all three TYPO3 upgrade workflows consecutively in a single chained session (upgrade execution → ExtensionScanner → static code tests). Also activate /typo3-workflows:typo3-upgrade, /typo3-workflows:typo3-scanner, and /typo3-workflows:typo3-static-tests in the same session to make all workflow content available. Applies Batch.md §6 chaining model with a single toolset gate, single preflight, and one final Phase 9 handover for the full chain."
...
- `/typo3-workflows:typo3-upgrade-full` — this orchestration skill
- `/typo3-workflows:typo3-upgrade` — upgrade execution + DoD content
- `/typo3-workflows:typo3-scanner` — ExtensionScanner workflow content
- `/typo3-workflows:typo3-static-tests` — static code test workflow content
...
3. **Workflow 1 — `/typo3-workflows:typo3-upgrade`**: execute phases 2–9 to completion.
   - Produce inter-workflow handoff note: what was completed, what state the scanner
     workflow inherits, any open items.
4. **Workflow 2 — `/typo3-workflows:typo3-scanner`**: execute phases 2–9 to completion.
   - Produce inter-workflow handoff note: what was completed, what state the
     static-tests workflow inherits, any open items.
5. **Workflow 3 — `/typo3-workflows:typo3-static-tests`**: execute phases 2–9 to completion.
