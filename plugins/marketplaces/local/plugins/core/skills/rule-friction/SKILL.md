---
name: rule-friction
description: "Run the rule-set feedback loop over aggregated usage-data facets (bin/rule-friction-report.sh) and emit Meta.md §3.1 improvement proposals. explicit activation required. Triggers: 'rule friction report', 'mine usage data', 'which rules are failing/working', periodic rule-set health review."
