...
| P10 | in progress | G1: Ja (2026-07-16) | Split in Gruppen G1-G8 (siehe Session-Bootstrap-Nachtrag). G1 done: §4.5-Retro-Trigger → batch §3.1, §12-Release-Mechanik → major-upgrade §4 Phase 1, Deployment-Trigger-Bullet komprimiert (Sicherheitssatz wortgleich erhalten). General.md 10461 → 10340 est. tokens (−121; unter Review-Schätzung, da Per-Occurrence-Katalog/Payload-Replay/Protected-Set always-on bleiben müssen). Offen: G2 (F5-Dups), G3 (Persona), G4-G7 (Descriptions je Plugin core/composer/typo3/pocock), G8 (CLAUDE.md-Ledger + Nachmessung). |
