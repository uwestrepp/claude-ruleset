...
* **TYPO3 workflow skills** — explicit activation required; see `TYPO3.md` §9 for trigger patterns:
  * `/typo3:typo3-upgrade` (`~/.claude/plugins/marketplaces/local/plugins/typo3/skills/typo3-upgrade/`)
    ...
    * Activate with: `/typo3:typo3-upgrade` before any TYPO3 upgrade/migration execution task.
  * `/typo3:typo3-scanner` (`~/.claude/plugins/marketplaces/local/plugins/typo3/skills/typo3-scanner/`)
    ...
    * Activate with: `/typo3:typo3-scanner` before any ExtensionScanner triage or scanner-driven migration.
  * `/typo3:typo3-static-tests` (`~/.claude/plugins/marketplaces/local/plugins/typo3/skills/typo3-static-tests/`)
    ...
    * Activate with: `/typo3:typo3-static-tests` before any static analyzer/fixer cycle.
  * `/typo3:typo3-upgrade-full` (`~/.claude/plugins/marketplaces/local/plugins/typo3/skills/typo3-upgrade-full/`)
    * Description: TYPO3 Full Upgrade Chain — orchestration skill that chains all three workflows consecutively (upgrade → scanner → static-tests) per the `/core:batch` skill §6. Activate alongside the three component skills.
    * Activate with: `/typo3:typo3-upgrade-full` + `/typo3:typo3-upgrade` + `/typo3:typo3-scanner` + `/typo3:typo3-static-tests` for a full chained session.
