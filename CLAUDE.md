...
* Follow the rules as defined in this explicit rule index:
  ...
  * @rules/General.md `[CRITICAL]`
    * Description: Global baseline behavior (assumptions, validation discipline, safety, environment-aware command routing, upstream contract verification, ticket traceability for commits, skill invocation gate).
    * When to use: Always; re-read on every context revalidation event (General.md §3.4).
  * @rules/CleanCode.md
